...
sealed class SsaInstr {
    ...
    data class LoadFunc(
        ...
        val constants: List<org.inklang.lang.Value>,
        val defaultValues: List<org.inklang.lang.DefaultValueInfo?> = emptyList()
    ) : SsaInstr() {
        override val usedValues: List<SsaValue> = emptyList()
    }
    ...
    data class LoadClass(
        ...
        val methods: Map<String, org.inklang.lang.MethodInfo>
    ) : SsaInstr() {
        override val usedValues: List<SsaValue> = emptyList()
    }
